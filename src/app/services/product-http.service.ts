...
import { CreateProductDto, ProductModel, UpdateProductsDto } from '../modules/product.model';
...
update(id:ProductModel['id'], product:UpdateProductsDto):Observable<ProductModel[]> {
  const url = `${this.API_URL}/${id}`; 
